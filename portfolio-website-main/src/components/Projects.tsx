...
const Projects = () => {
  ...
  const projects = [
    {
      id: 1,
      title: "FreshStart- Career guidance",
      description: "Developed an interactive web application that helps monitor student on attachment and post graduates without working expirience and link them with industries .",
    ...
    {
      id: 2,
      title: "Simba's Portfolio Website – Interactive & Animated",
