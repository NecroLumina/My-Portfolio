...
const Chatbot: React.FC = () => {
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      ...
      let reply = "Hy, how are you , l am here to assist you in understanding this portfolio? Ask me about the developer's skills, projects, or experience using key words , contact, services, react, gsap, project.";

      if (userInput.includes("services")) {
        reply = "Simba offers services in frontend, backend development, animations, and AI integration. Would you like a portfolio link?";
      } else if (userInput.includes("contact")) {
        reply = "You can contact Simba via the contact form above or email him directly at simbakay141@gmail.com";
      } else if (userInput.includes("react") || userInput.includes("gsap")) {
        reply = "Yes! Simba uses React, GSAP, and even WebGL to build stunning UIs.";
      } else if (userInput.includes("project")) {
        reply = "Tell me more about your project! Simba can help with frontend, backend, UI/UX design, and building full-stack web applications.";
      }
